...
| `/gallery` | ภาพบรรยากาศ |
| `/rules` | ระเบียบการแข่งขัน 18 ข้อ + สกินที่ห้ามใช้ 57 รายการ + ตารางบทลงโทษ + รางวัล + FAQ |
...
- **แก้ไขได้ทุกตาราง** — คู่แข่งขัน, ทีม, นักกีฬา, กำหนดการ, ข่าว, ภาพ, รายการแข่ง, กติกา, สกินที่ห้ามใช้, ตารางบทลงโทษ, รางวัล, FAQ, ผู้สนับสนุน
...
NEXT_PUBLIC_SITE_URL="https://obec-xbenchan.vercel.app"
...
| ระเบียบ กติกา สกินที่ห้ามใช้ บทลงโทษ และรางวัล | ระเบียบการแข่งขันกีฬา E-Sport เกม Arena of Valor (RoV) ฉบับสมบูรณ์ |

ทีมที่ส่งใบสมัครแต่ไม่ปรากฏในผังสายถือว่าถูกตัดสิทธิ์ และไม่ถูกนำขึ้นเว็บ

**รูปแบบการแข่งขัน** — สายหลัก (Upper Bracket) แพ้คัดออก Bo3 ทุกรอบรวมถึงรอบชิงชนะเลิศ
ตรงกับผังบน Challonge ทั้งสองรุ่น · ส่วนสายแก้ตัว (Lower Bracket) ชิงอันดับที่ 5
ตามระเบียบข้อ 4.2.2 ยังไม่มีคู่ในผัง Challonge จึงแสดงเป็นหมายเหตุไว้ที่หน้าสายการแข่งขัน
หากต้องการเพิ่มคู่สายแก้ตัว ทำได้ที่แผงผู้ดูแล เมนู "คู่การแข่งขัน"
