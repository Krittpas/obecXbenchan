  ...
  return (
    <>
      <PageHead
        ...
        title="สายการแข่งขัน"
        lead="แข่งแบบแพ้คัดออกทุกรอบ ระบบ Bo3 ทีมที่แพ้ตกรอบทันที ผลจะอัปเดตทันทีที่จบแต่ละแมตช์"
      />
      ...
      <section>
        <div className="shell">
          ...
          <p className="note">
            ...
            “ผู้ชนะคู่ …” ตามรหัสคู่ในรอบก่อนหน้า · แข่งแบบแพ้คัดออกทุกรอบ ทีมที่แพ้ตกรอบทันที
          </p>
        </div>
      </section>
    </>
