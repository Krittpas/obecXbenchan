          ...
          <div className="grid-4" style={{ marginBottom: "1.6rem" }}>
            <div className="card fact">
              <dl>
                ...
                <dd>
                  แพ้คัดออก
                  <small>สายหลัก Bo3 ทุกรอบ · มีสายแก้ตัวชิงอันดับ 5</small>
                </dd>
              </dl>
            </div>
            <div className="card fact">
          ...
          <div className="grid-2">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              <div className="venue-card">
                ...
                <p>
                  โทรศัพท์สมาร์ตโฟนของตนเอง (ห้าม Tablet และ iPad) อินเทอร์เน็ตเคลื่อนที่ของตนเอง
                  หูฟัง ปลั๊กต่อพ่วง และบัตรประจำตัวนักเรียน · แต่งกายด้วยชุดพละและรองเท้าผ้าใบ ·
                  สแตนด์บายในห้องแข่งขันก่อนเวลาแข่งขัน 15 นาที
                </p>
              </div>
              <div className="venue-card">
